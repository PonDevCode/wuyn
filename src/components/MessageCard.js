...
const messages = [
"Chúc mày một ngày 8/3 thật vui vẻ, luôn mạnh mẽ và xinh đẹp như cách mày luôn tỏa sáng trong cuộc sống này.",
    "Mày không chỉ là một người bạn tuyệt vời mà còn là người đồng hành đích thực, luôn khiến cuộc sống của mình thêm thú vị và ý nghĩa.",
   "Chúc mày luôn hạnh phúc, tươi cười và đạt được tất cả những ước mơ, hoài bão trong cuộc đời. Cảm ơn vì luôn ở bên cạnh tao!",
    "Mong rằng mỗi ngày của mày đều tràn đầy niềm vui, yêu thương và may mắn. Mày xứng đáng với tất cả những điều tốt đẹp nhất!",
    "Chúc mày luôn là cô gái độc lập, mạnh mẽ và xinh đẹp trong mắt mọi người, đặc biệt là trong mắt tao. Happy Women’s Day!",
   "Cảm ơn mày vì luôn là người bạn luôn biết lắng nghe, chia sẻ và mang lại niềm vui cho tao. Chúc mày một ngày 8/3 thật đáng nhớ và ý nghĩa!"
];
